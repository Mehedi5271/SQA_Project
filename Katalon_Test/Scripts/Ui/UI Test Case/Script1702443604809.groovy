...
WebUI.doubleClick(findTestObject('Object Repository/Page_CURA Healthcare Service/input_form-control'))
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/input_form-control_1'), 'ThisIsNotAPassword')

WebUI.doubleClick(findTestObject('Object Repository/Page_CURA Healthcare Service/input_form-control_1'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/input_form-control_1'))
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_comment'), 'ui')
